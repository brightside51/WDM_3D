...
#SBATCH --output=../MetaBreast/logs/wdm3d/V2/output.out           # Filename with STDOUT. You can use special flags, such as %N and %j.
#SBATCH --error=../MetaBreast/logs/wdm3d/V2/error.err             # (Optional) Filename with STDERR. If ommited, use STDOUT.
